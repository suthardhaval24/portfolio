                        ...
                        <div className="row row-pt-md">
                            <div className="col-md-4 text-center animate-box">
                                <div className="services color-1">
                                    ...
                                    <div className="desc">
                                        <h3>Enterpise/Web Applications </h3>
                                        <p>I have professional experience building Enterprise Applications and Web Applications utilizing full-stack Engineering</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4 text-center animate-box">
                            ...
                            <div className="col-md-4 text-center animate-box">
                                <div className="services color-5">
                                    ...
                                    <div className="desc">
                                        <h3>AWS & Dev Ops</h3>
                                        <p>knowledge of DevOps practices and AWS services to implement CI/CD Pipelines and Deployment.</p>
                                    </div>
                                </div>
                            </div>
                            {/*
